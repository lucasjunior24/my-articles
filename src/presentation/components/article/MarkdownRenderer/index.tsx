 ...
 *
 * Envolvido com React.memo para evitar re-renders ao editar campos
 * que não afetam o conteúdo renderizado. O objeto `components` é
 * memoizado com useMemo para estabilidade de referência.
 *
 * @example
 * ```tsx
